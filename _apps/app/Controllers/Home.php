...
class Home extends BaseController
{
	...
	public function index()
	{
		...
		$render = [
			...
			'service_city_data'    		 => $homeModel->getServiceCity()->getResult(),
	...
	public function landing($landing_id = null, $landing_slug = null)
	{
		...
		$render['service_city_data']   		= $homeModel->getServiceCity()->getResult();
		...
		if (isset($_POST['wilayah'])) {
			...
			$w = $homeModel->getService(" WHERE service_category_id=$service AND service_city_id=$wilayah")->getResult();
			...
			foreach ($w as $ser) {
				$city = $homeModel->getServiceCity(" WHERE city_id=$ser->service_city_id")->getRow();
				$cost = $ser->service_cost;
				$render['result'] .= '
						<tr>
							<td>
								' . $ser->service_name . '
													...
													<div class="col-md-12">
														<div class="form-login">
															...
															<form id="form" method="post" action="' . base_url() . '/home/booking">
																...
																<input type="hidden" name="service_city_name" value="' . $city->city_name . '">
					...
					>
					  <div class="accordion-body">
						...
						<div class="wrapper-table-content">
						  ...
						  <p class="table-title">' . $city->city_name . '</p>
						</div>
						<div class="wrapper-table-content">
						  <p class="table-header">Harga</p>
						  <p class="table-title">' . number_format($cost, 0, '.', ',');
